<template>
    <div
        ...
        <div class="shrink-0 sticky top-0 bg-[#FAFAFA] z-[5] h-[var(--status-bar-height,0)]"></div>

        <div v-if="!single" class="hidden max-md:flex flex-shrink-0 items-center justify-between sticky top-[var(--status-bar-height,0)] h-[52px] px-12 bg-[#FAFAFA] z-[5]">
